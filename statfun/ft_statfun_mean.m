...
% the observations (e.g. channel-time-frequency points or voxels).
%
...
%
% See also FT_STATFUN_DIFF for another simple example and
% FT_TIMELOCKSTATISTICS, FT_FREQSTATISTICS or FT_SOURCESTATISTICS for
% general usage.
